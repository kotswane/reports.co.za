...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Company Name Search</li>
    </ol>
</section>
<section class="content">
    <div class="box">
        <div class="box-header with-border">
            <h3 class="box-title">Company Name Search</h3>
            <div class="box-tools pull-right">
                <a href="<?php echo site_url();?>/procurementreport/companyname" type="button" class="btn btn-box-tool"><i class="fa fa-list-ul"></i></a>
            </div>
        </div>
           <!-- Error Alert -->
            <?php if($errorMessage != ""){?>
		   ...
		   <?php }?>
        <form data-toggle="validator" role="Company Name Search" action="<?php echo site_url();?>/procurementreport/companyname" method="post">
            <div class="box-body">
